...
def move(robot):
    ...
    while robot.step(timestep) != -1:
        ...
        targ_angle = calc_poly_tang(tree_poly, p1)
        curr_angle = calc_poly_tang([p1], p2)
        
        if calc_poly_dist(goal_poly, p2) < 0:
        ...
        if abs(targ_angle - curr_angle) > 0.2 and not frn_wall and not rgt_wall:
